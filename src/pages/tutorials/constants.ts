...
export const VIDEOS = 'videos on LOCO THE TRADER';
...
export const user_guide_content = (): TUserGuideContent[] => [
    {
        ...
        type: 'Tour',
        subtype: 'OnBoard',
        content: localize('Get started on LOCO THE TRADER'),
...
export const guide_content = (): TGuideContent[] => [
    {
        id: 1,
        type: 'DBotVideo',
        content: localize('An introduction to LOCO THE TRADER'),
    ...
    },
    {
        id: 2,
        type: 'DBotVideo',
        content: localize('How to build a basic trading bot with LOCO THE TRADER'),
    ...
    },
    {
        id: 3,
        type: 'DBotVideo',
        content: localize('How to use Martingale strategy on LOCO THE TRADER'),
...
export const faq_content = (): TFaqContent[] => [
    {
        title: localize('What is LOCO THE TRADER?'),
        description: [
            {
                type: 'text',
                content: localize(
                    "LOCO THE TRADER is a web-based strategy builder for trading digital options. It’s a platform where you can build your own automated trading bot using drag-and-drop 'blocks'."
                ),
            },
        ],
        search_id: 'faq-0',
    ...
    {
        title: localize('Do you offer pre-built trading bots on LOCO THE TRADER?'),
        description: [
            {
                type: 'text',
                content: localize(
        ...
        description: [
            {
                type: 'text',
                content: localize(
                    "A quick strategy is a ready-made strategy that you can use in LOCO THE TRADER. There are 3 quick strategies you can choose from: Martingale, D'Alembert, and Oscar's Grind."
                ),
            },
            {
                type: 'text',
    ...
    {
        title: localize('How do I import my own trading bot into LOCO THE TRADER?'),
        description: [
            {
                type: 'text',
                content: localize(
    ...
    {
        title: localize('How do I control my losses with LOCO THE TRADER?'),
        description: [
            {
                type: 'text',
                content: localize(
                    'There are several ways to control your losses with LOCO THE TRADER. Here’s a simple example of how you can implement loss control in your strategy:'
                ),
            },
            {
                type: 'image',
    ...
    {
        title: localize('Can I run LOCO THE TRADER on multiple tabs in my web browser?'),
        description: [
            {
                type: 'text',
                content: localize(
    ...
    {
        title: localize('Can I trade cryptocurrencies on LOCO THE TRADER?'),
        description: [
            {
                type: 'text',
                content: localize("No, we don't offer cryptocurrencies on LOCO THE TRADER."),
            },
        ],
        search_id: 'faq-12',
    },
        ...
        description: [
            {
                type: 'text',
                content: localize(
                    "No, we don't. However, you'll find quick strategies on LOCO THE TRADER that'll help you build your own trading bot for free."
                ),
            },
        ],
        search_id: 'faq-13',
    ...
    {
        title: localize('In which countries is LOCO THE TRADER available?'),
        description: [
            {
                type: 'text',
                content: localize(
    ...
    {
        title: localize('If I close my web browser, will LOCO THE TRADER continue to run?'),
        description: [
            {
                type: 'text',
                content: localize('No, LOCO THE TRADER will stop running when your web browser is closed.'),
            },
        ],
        search_id: 'faq-15',
    },
        ...
        description: [
            {
                type: 'text',
                content: localize(
                    "Three of the most commonly used strategies in automated trading are Martingale, D'Alembert, and Oscar's Grind — you can find them all ready-made and waiting for you in LOCO THE TRADER."
                ),
            },
        ],
        search_id: 'faq-16',
...
export const quick_strategy_content = (): TQuickStrategyContent[] => [
    {
        ...
        content: [
            localize('Exploring the Martingale strategy in LOCO THE TRADER'),
    ...
    },
    {
        ...
        content: [
            localize('Exploring the D’Alembert strategy in LOCO THE TRADER'),
    ...
    },
    {
        ...
        content: [
            localize('Exploring the Oscar’s Grind strategy in LOCO THE TRADER'),
    ...
    },
    {
        ...
        content: [
            localize('Exploring the Reverse Martingale strategy in LOCO THE TRADER'),
    ...
    },
    {
        ...
        content: [
            localize('Exploring the Reverse D’Alembert strategy in LOCO THE TRADER'),
