...
const VirtualHookModal = observer(({ is_open, onClose }: Partial<VirtualHookModalProps>) => {
    ...
    const { is_enabled, enable_after_initial, virtual_trades_condition, real_trades_condition } =
    ...
    return (
        <Modal is_open={isOpen} className='virtual-hook-modal' toggleModal={handleClose} has_close_icon>
            <div className='virtual-hook-modal__header-content'>
                <div className='icon-container'>
                    <svg viewBox='0 0 24 24' style={{ fill: 'white', width: 32, height: 32 }}>
                        <path d='M13 2.05v3.03c3.39.49 6 3.39 6 6.92 0 .9-.18 1.75-.5 2.54l2.6 1.53c.56-1.24.9-2.62.9-4.07 0-5.17-3.92-9.42-8.98-9.95zM12 19c-3.87 0-7-3.13-7-7 0-3.53 2.61-6.43 6-6.92V2.05c-5.06.53-9 4.78-9 9.95 0 5.52 4.48 10 10 10 2.67 0 5.11-1.03 6.96-2.71l-2.12-2.12C15.32 18.43 13.74 19 12 19zM11 2v3.04C7.61 5.53 5 8.43 5 11.96c0 .9.18 1.75.5 2.54l-2.6 1.53C2.34 14.79 2 13.41 2 11.96c0-5.17 3.92-9.43 8.98-9.96z' />
                    </svg>
                </div>
            ...
            <div className='virtual-hook-modal__toggle-section'>
                <label className='switch'>
                    <input type='checkbox' checked={is_enabled} onChange={toggleEnabled} />
            ...
            <div className='virtual-hook-modal__setting-card'>
                ...
                <div className='virtual-hook-modal__setting-card--right'>
                    <input type='text' value={enable_after_initial} readOnly style={{ opacity: 0.7 }} />
                </div>
            </div>
            ...
            <div className='virtual-hook-modal__setting-card'>
                ...
                <div
                    className='virtual-hook-modal__setting-card--right'
            ...
            <div className='virtual-hook-modal__setting-card'>
                ...
                <div className='virtual-hook-modal__setting-card--right'>
                    <input type='text' value={real_trades_condition} readOnly style={{ opacity: 0.7 }} />
                </div>
            </div>
